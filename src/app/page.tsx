            ...
            {showOtpInput ? (
              ...
              <>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 outline-[#15803D] focus:ring-[#15803D] rounded-md"
                />
                <input
                  type="text"
                ...
                <button
                  type="submit"
                  className="w-full py-2 bg-white border border-gray-300 outline-[#15803D] focus:ring-[#15803D] hover:bg-gray-100 text-gray-700 font-medium rounded-md"
                  disabled={loading}
                >
